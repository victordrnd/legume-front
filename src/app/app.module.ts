...
@NgModule({
  ...
  declarations: [AppComponent, HeaderComponent, FooterComponent, LoginComponent, RegisterComponent, HomeComponent, BookingComponent, BookingsTableComponent, CreateBookingModalComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    FormsModule,
